...
/*! \brief  Initialize LCD_displayData buffer. Set up the LCD (timing, contrast, etc.)
 */
void LCD_Init (void)
{
...
/*! \brief  Latch the LCD_displayData and Set LCD_status.updateComplete.
 */
#pragma vector = LCD_SOF_vect
__interrupt void LCD_SOF_interrupt( void )
//#pragma vector = LCD_START_FRAME_vect
//__interrupt void LCD_START_FRAME_interrupt( void )
{
	unsigned char i;
