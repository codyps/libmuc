#ifndef _SOFTUART_H_
#if defined(_SOFTUART_H_)
#error FAILLLLLLLL
#endif
#define _SOFTUART_H_ 1
#include <stdio.h>
...
#define SOFTUART_CPU 3*SOFTUART_BAUD_RATE*SOFTUART_PRESCALE*SOFTUART_TIMERTOP+3*SOFTUART_BAUD_RATE*SOFTUART_PRESCALE
...
// Called at every timer interupt
//void softuart_int_handler(void);

// Functions for interface with general io
void softuart_stderr(void);
