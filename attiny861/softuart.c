...
static int softuart_putchar_stream( char c, FILE *stream );
static FILE suart_out = FDEV_SETUP_STREAM( softuart_putchar_stream, NULL, _FDEV_SETUP_WRITE );
...
void softuart_init( void )
{
	...
	timer0_init(); // replaces the two calls above
